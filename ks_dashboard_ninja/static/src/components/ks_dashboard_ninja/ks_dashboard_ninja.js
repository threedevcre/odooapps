...
import {
    Component, onRendered, onWillStart, useState, onPatched, useChildSubEnv, useSubEnv, onWillUnmount,
    onMounted, onWillRender, onWillPatch, useRef, useEffect,  reactive, markRaw
} from "@odoo/owl";
...
//        useBus(this.env.bus, "GET:ParamsForItemFetch", (ev) => this.ksGetParamsForItemFetch(ev.detail));
    ...
    async fetchDashboardConfigs(){
        ...
        Object.assign(this.state, {
            ...
            dateFilterConfig: getSessionStorage(sessionKeys.dateFilter + this.ks_dashboard_id) || result.dashboard_data.dateFilterData.config
        })
    }
