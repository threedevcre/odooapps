            ...
            if self.ks_chart_groupby_type == 'relational_type':
                ...
                try:
                    ...
                    read_group(ks_chart_domain, ks_list_fields, [self.ks_chart_relation_groupby.name],
                               orderby=orderby, offset=ksoffset, lazy=False)
                except Exception as e:
                    ks_list_view_records = []

                ks_list_view_data['total'] = len(ks_list_view_records) + ksoffset
                ...
                try:
                    ks_list_view_records = self.env[self.ks_model_name].read_group(ks_chart_domain, ks_list_field + list_target_deviation_field,
